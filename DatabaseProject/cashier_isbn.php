...
<html>
 <head>
  <title>isbn.php</title>
 </head>
 <body>

<H1>Book search by isbn</H1>
 ...
 <?php
	...
	echo "<h2>You searched for a book by the isbn '" . $bookNum . "'</h2>";
?>
...
<?php
	...
	$sql = "SELECT isbn, title, priceEach, quantityInStock " .
         "FROM bookstore.books " .
	       "WHERE isbn = '" . $bookNum . "'";
	//echo "Searching " . $sql . "</h4>";
 ...
 <form action="cashier_isbn_search.html" method="get">
